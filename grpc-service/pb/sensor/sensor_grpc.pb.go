...
const (
	...
	SensorService_PageSensors_FullMethodName          = "/sensor.SensorService/PageSensors"
)
...
type SensorServiceClient interface {
	...
	PageSensors(ctx context.Context, in *PageSensorsRequest, opts ...grpc.CallOption) (*PageSensorsResponse, error)
}
...
func (c *sensorServiceClient) PageSensors(ctx context.Context, in *PageSensorsRequest, opts ...grpc.CallOption) (*PageSensorsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PageSensorsResponse)
	err := c.cc.Invoke(ctx, SensorService_PageSensors_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SensorServiceServer interface {
	...
	PageSensors(context.Context, *PageSensorsRequest) (*PageSensorsResponse, error)
...
func (UnimplementedSensorServiceServer) PageSensors(context.Context, *PageSensorsRequest) (*PageSensorsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PageSensors not implemented")
}
...
func _SensorService_PageSensors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PageSensorsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SensorServiceServer).PageSensors(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SensorService_PageSensors_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SensorServiceServer).PageSensors(ctx, req.(*PageSensorsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SensorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PageSensors",
			Handler:    _SensorService_PageSensors_Handler,
		},
	},
